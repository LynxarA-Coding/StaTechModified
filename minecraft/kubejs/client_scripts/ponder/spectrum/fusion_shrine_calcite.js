...
Ponder.registry((event) => {
    ...
    event.create('spectrum:fusion_shrine_calcite').scene('fusion_shrine', 'The Fusion Shrine Structure', 'kubejs:spectrum_fusion_shrine', (scene, util) => {
        ...
        addText(scene, 60, 'Note the slabs surrounding the base of the shrine itself', PonderPalette.WHITE, [6.0, 2.0, 4.0]);
